    ...
    class CodeSection {
      ...
      processForIndex(node, idx) {
        ...
        sstepDivs.forEach(sstepDiv => {
          sstepDiv.classList.add('show-code');
          ...
          if (showRange.firstIndex() == idx) {
            ...
            sstepDiv.classList.remove('code-firsthidden');
            if (sstepDiv.classList.contains('code-firstshown')) {
              sstepDiv.classList.remove('code-firstshown');
              sstepDiv.classList.add('code-firsthidden');
            }
